                ...
                <form class="form-container" name="prescription" method="post" onsubmit="return validate()">
                    <div class="form-group">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control" aria-describeby="emailHelp" name="emailid" placeholder="Enter your email" required />
                        </div>
                        <div class="mb-3">
                            <label for="mobileno">Mobile Number<span style="color: red;"> *</span></label>
                            <input type="number" class="form-control" placeholder="+91" name="mobileno" maxlength="10" required />
                        </div>
                        <div class="mb-3">
                            <label for="choose_img">Choose a file <span style="color: red;"> *</span></label> <br>
                            <input type="file" id="prescription" accept="image/*" name="prescription">
                        </div>
                        <a href="prescription.html"><button type="submit" class="btn btn-primary">Submit</button></a> &nbsp;&nbsp;
